...
class PayGate(object):
    ...
    def get_user_template_simple(self, toID, users):
        ...
        #####################################
        # users[0]
        JSON_Datalist = """{"recipient":{"id":"USER_ID"},"message":{"text":"Who would you like to message?","quick_replies":[{"""
        ...
        the_dict['message']['quick_replies'][1]['title'] = users[2]['firstName']
        the_dict['message']['quick_replies'][1]['image_url'] = users[2]['imgUrl']
