...
class PayGate(object):
    ...
    def get_user_template_simple(self, toID):
        ...
        # convert dict into json
        #####################################
        JSON_Datalist = """{"recipient":{"id":"RECIPIENT_ID"},"message":{"attachment":{"type":"template","payload":{"template_type":"list","elements":[{"title":"Classic T-Shirt Collection","image_url":"http://cdn.hercampus.com/s3fs-public/2013/09/22/venmo%201.gif","subtitle":"See all our colors","default_action":{"type":"web_url","url":"http://cdn.hercampus.com/s3fs-public/2013/09/22/venmo%201.gif","messenger_extensions":true,"webview_height_ratio":"tall","fallback_url":"http://cdn.hercampus.com/s3fs-public/2013/09/22/venmo%201.gif"},"buttons":[{"title":"View","type":"web_url","url":"http://cdn.hercampus.com/s3fs-public/2013/09/22/venmo%201.gif","messenger_extensions":true,"webview_height_ratio":"tall","fallback_url":"http://cdn.hercampus.com/s3fs-public/2013/09/22/venmo%201.gif"}]},{"title":"Classic White T-Shirt","image_url":"http://cdn.hercampus.com/s3fs-public/2013/09/22/venmo%201.gif","subtitle":"100% Cotton, 200% Comfortable","default_action":{"type":"web_url","url":"http://cdn.hercampus.com/s3fs-public/2013/09/22/venmo%201.gif","messenger_extensions":true,"webview_height_ratio":"tall","fallback_url":"http://cdn.hercampus.com/s3fs-public/2013/09/22/venmo%201.gif"},"buttons":[{"title":"Shop Now","type":"web_url","url":"http://cdn.hercampus.com/s3fs-public/2013/09/22/venmo%201.gif","messenger_extensions":true,"webview_height_ratio":"tall","fallback_url":"http://cdn.hercampus.com/s3fs-public/2013/09/22/venmo%201.gif"}]},{"title":"Classic Blue T-Shirt","image_url":"http://cdn.hercampus.com/s3fs-public/2013/09/22/venmo%201.gif","subtitle":"100% Cotton, 200% Comfortable","default_action":{"type":"web_url","url":"http://cdn.hercampus.com/s3fs-public/2013/09/22/venmo%201.gif","messenger_extensions":true,"webview_height_ratio":"tall","fallback_url":"http://cdn.hercampus.com/s3fs-public/2013/09/22/venmo%201.gif"},"buttons":[{"title":"Shop Now","type":"web_url","url":"http://cdn.hercampus.com/s3fs-public/2013/09/22/venmo%201.gif","messenger_extensions":true,"webview_height_ratio":"tall","fallback_url":"https://peterssendreceiveapp.ngrok.io/"}]},{"title":"Classic Black T-Shirt","image_url":"https://peterssendreceiveapp.ngrok.io/img/black-t-shirt.png","subtitle":"100% Cotton, 200% Comfortable","default_action":{"type":"web_url","url":"https://peterssendreceiveapp.ngrok.io/view?item=102","messenger_extensions":true,"webview_height_ratio":"tall","fallback_url":"https://peterssendreceiveapp.ngrok.io/"},"buttons":[{"title":"Shop Now","type":"web_url","url":"https://peterssendreceiveapp.ngrok.io/shop?item=102","messenger_extensions":true,"webview_height_ratio":"tall","fallback_url":"https://peterssendreceiveapp.ngrok.io/"}]}],"buttons":[{"title":"View More","type":"postback","payload":"payload"}]}}}}""" 
