...
class PayGate(object):
    ...
    def get_user_template_simple(self, toID):
        ...
        # convert dict into json
        #####################################
        JSON_Datalist = """{"recipient":{"id":"recipientId"},"message":{"attachment":{"type":"template","payload":{"template_type":"list","elements":[{"title":"Venmo","subtitle":"Please make your payment with Venmo","item_url":"https://venmo.com","image_url":"http://cdn.hercampus.com/s3fs-public/2013/09/22/venmo%201.gif","buttons":[{"type":"web_url","url":"https://venmo.com/account/sign-in","title":"Pay"},{"type":"postback","title":"Call Postback","payload":"Payload for first bubble"}]}]}}}}"""
