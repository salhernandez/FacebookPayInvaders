...
class QuickReply(object):
    ...
    def send_action_quick_reply(self, toID):
        ...
        #####################################
        JSON_Datalist = """{ "recipient":{ "id":"USER_ID" }, "message":{"quick_replies":[ { "content_type":"text", "title":"Pay", "payload":" 'responseType':'action', 'value':'pay' " }, { "content_type":"text", "title":"Request", "payload":" 'responseType':'action', 'value':'request' " }, { "content_type":"text", "title":"Split", "payload":" 'responseType':'action', 'value':'split' " } ] } }"""
